...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n/* harmony import */ var _project_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project.js */ \"./src/project.js\");\n/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storage.js */ \"./src/storage.js\");\n // Importing CSS\r\n// index.js\r\n\r\n\r\n\r\n\r\nconst app = {\r\n    projects: [],\r\n    activeProject: null,\r\n\r\n    init() {\r\n        this.loadFromLocalStorage();\r\n        this.renderProjects();\r\n        this.setupEventListeners();\r\n    },\r\n\r\n    setupEventListeners() {\r\n        document.getElementById(\"add-project\").addEventListener(\"click\", () => {\r\n            const projectName = prompt(\"Enter Project Name:\");\r\n            if (projectName) {\r\n                const newProject = new _project_js__WEBPACK_IMPORTED_MODULE_2__.Project(projectName);\r\n                this.projects.push(newProject);\r\n                this.saveToLocalStorage();\r\n                this.renderProjects();\r\n            }\r\n        });\r\n\r\n        document.getElementById(\"add-todo\").addEventListener(\"click\", () => {\r\n            if (!this.activeProject) {\r\n                alert(\"Select a project first!\");\r\n                return;\r\n            }\r\n            const title = prompt(\"Enter Todo Title:\");\r\n            if (title) {\r\n                const dueDate = prompt(\"Enter Due Date (YYYY-MM-DD):\");\r\n                const todo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__.Todo(title, \"\", dueDate);\r\n                this.activeProject.addTodo(todo);\r\n                this.saveToLocalStorage();\r\n                this.renderTodos();\r\n            }\r\n        });\r\n    },\r\n\r\n    renderProjects() {\r\n        const projectList = document.getElementById(\"project-list\");\r\n        projectList.innerHTML = '';\r\n\r\n        this.projects.forEach((project, index) => {\r\n            const li = document.createElement(\"li\");\r\n            li.innerText = project.name;\r\n            li.onclick = () => {\r\n                this.activeProject = project;\r\n                this.renderTodos();\r\n            };\r\n            projectList.appendChild(li);\r\n        });\r\n    },\r\n\r\n    renderTodos() {\r\n        const todoList = document.getElementById(\"todo-list\");\r\n        todoList.innerHTML = '';\r\n\r\n        if (!this.activeProject) return;\r\n\r\n        this.activeProject.todos.forEach(todo => {\r\n            const li = document.createElement(\"li\");\r\n            li.innerText = todo.title + \" (Due: \" + todo.dueDate.toDateString() + \")\";\r\n            li.className = todo.isComplete ? 'completed' : '';\r\n            li.onclick = () => {\r\n                todo.toggleCompletion();\r\n                this.saveToLocalStorage();\r\n                this.renderTodos();\r\n            };\r\n            todoList.appendChild(li);\r\n        });\r\n    },\r\n\r\n    saveToLocalStorage() {\r\n        (0,_storage_js__WEBPACK_IMPORTED_MODULE_3__.saveToLocalStorage)(this.projects);\r\n    },\r\n\r\n    loadFromLocalStorage() {\r\n        const data = (0,_storage_js__WEBPACK_IMPORTED_MODULE_3__.loadFromLocalStorage)();\r\n        if (data) {\r\n            this.projects = data.map(p => {\r\n                const project = new _project_js__WEBPACK_IMPORTED_MODULE_2__.Project(p.name);\r\n                p.todos.forEach(t => {\r\n                    const todo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__.Todo(t.title, t.description, t.dueDate, t.priority, t.notes, t.checklist);\r\n                    todo.isComplete = t.isComplete;\r\n                    project.addTodo(todo);\r\n                });\r\n                return project;\r\n            });\r\n        }\r\n    }\r\n};\r\n\r\ndocument.addEventListener(\"DOMContentLoaded\", () => app.init());\n\n//# sourceURL=webpack://webpack-practice/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Project: () => (/* binding */ Project)\n/* harmony export */ });\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n\r\n\r\nclass Project {\r\n    constructor(name) {\r\n        this.name = name;\r\n        this.todos = [];\r\n    }\r\n    \r\n    addTodo(todo) {\r\n        this.todos.push(todo);\r\n    }\r\n    \r\n    removeTodo(todoId) {\r\n        this.todos = this.todos.filter(todo => todo.id !== todoId);\r\n    }\r\n}\n\n//# sourceURL=webpack://webpack-practice/./src/project.js?");
